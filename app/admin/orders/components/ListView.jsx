			...
			<table className="border-separate border-spacing-y-3">
				<thead>
					<tr>
						...
						<th className="font-semibold border-y bg-white px-3 py-2 text-left">Total Price</th>
						<th className="font-semibold border-y bg-white px-3 py-2 text-left">Total Products</th>
						<th className="font-semibold border-y bg-white px-3 py-2 text-left">Payment Mode</th>
...
function Row({ item, index }) {
	...
	return (
		<tr>
			...
			<td className="border-y bg-white px-3 py-2  whitespace-nowrap">₦ {totalAmount}</td>
