...
import { useGroups } from '@/lib/firestore/groups/read'
import { deleteGroup } from '@/lib/firestore/groups/write'
...
function Row({ item, index }) {
	...
	const handleUpdate = () => {
		router.push(`/admin/groups?id=${item?.id}`)
	}
