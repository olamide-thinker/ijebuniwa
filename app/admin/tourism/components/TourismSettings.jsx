...
export default function TourismSettings({
    ...
    // Using same category storage for now, but specialized for Tourism UI
    ...
    return (
        <div className="flex flex-col gap-5">
            {/* Tourism specialized field: Location */}
            <section className="flex flex-col gap-4 p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-xs text-gray-500 font-medium" htmlFor="location-link">Google Maps Link</label>
                    <input
                        id="location-link"
                        type="url"
                        value={locationLink}
                        onChange={(e) => setLocationLink(e.target.value)}
                        className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-2 text-sm outline-none focus:border-gray-400 transition-all font-mono text-[10px]"
                        placeholder="https://goo.gl/maps/..."
                    />
                </div>
            </section>

            {/* Same Publish Settings Section as blog */}
            <section className="flex flex-col gap-4 p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Checkbox
                        ...
                        className="mt-1"
                    >
                        <span className="text-sm">Featured Attraction</span>
                    </Checkbox>
                </div>
            </section>
