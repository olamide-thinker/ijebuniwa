...
import { createTourismPost, updateTourismPost, publishTourismPost, autoSaveTourismPost } from '@/lib/firestore/tourism/write'
...
export default function CreateTourismPage() {
    ...
    const debouncedAutoSave = useCallback(
        ...
        [currentId, title, author, publishDate, isFeatured, categories, tags, locationLink],
    )
    ...
    const handleSaveDraft = async () => {
        ...
        try {
            ...
            let result
            if (currentId) {
                result = await updateTourismPost(currentId, data)
            } else {
                result = await createTourismPost(data)
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            if (!id) {
                ...
                await updateTourismPost(id, updateData)
            }
            const publishResult = await publishTourismPost(id)
    ...
    return (
        <main className="flex flex-col gap-4 p-5">
            <div className="flex items-center justify-between w-full">
                <BackBtn pageName="Create New Tourism Spot" />
                ...
                <div className="flex-[2] flex flex-col gap-5 h-fit">
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 flex flex-col min-h-[600px]">
                        ...
                        <div className="flex flex-col gap-1 mb-6">
                            <label className="text-xs text-gray-500 font-medium" htmlFor="spot-title">Spot Name / Title <span className="text-red-500">*</span></label>
                            <input
                                type="text"
                                id="spot-title"
                                value={title}
                                ...
                                placeholder="Enter spot name (e.g. Sungbo's Eredo)..."
                            />
                        </div>
